...
- **⚡ Maximum Performance**: Craft - Fastest overall with 58.1/100 score
...
| 🥈 2 | **[Immutable.js](https://github.com/immutable-js/immutable-js)** | 31.1/100 | 43% of fastest | [📦](https://www.npmjs.com/package/immutable) [📊](https://bundlephobia.com/package/immutable) |
...
| Rank | Library | Overall Score | Relative Performance | Links |
|:----:|---------|--------------|---------------------|:-----:|
| 🥇 1 | **[Craft](#)** | 58.1/100 | 100% of fastest | [📦](https://www.npmjs.com/package/craft) [📊](https://bundlephobia.com/package/craft) |
| 🥈 2 | **[Immer](https://github.com/immerjs/immer)** | 23.8/100 | 41% of fastest | [📦](https://www.npmjs.com/package/immer) [📊](https://bundlephobia.com/package/immer) |
...
|---------|:-----:|:------------------:|-------------|----------|
| **[Craft](#)** | **58.1** | N/A | State management solution... | General purpose... |
...
| Mutative | 412K | 0.003ms | 0.005ms | 1000 |
| Immer | 274K | 0.004ms | 0.008ms | 1000 |
...
| Seamless Immutable | 103K | 0.011ms | 0.020ms | 1000 |
...
| Immer | 186K | 0.005ms | 0.009ms | 1000 |
...
| Immutability Helper | 915K | 0.001ms | 0.002ms | 1000 |
...
| Native Spread | 342K | 0.003ms | 0.006ms | 1000 |
| Mutative | 207K | 0.005ms | 0.009ms | 1000 |
| Immutability Helper | 15K | 0.067ms | 0.080ms | 1000 |
| Craft | 7K | 0.148ms | 0.217ms | 1000 |
| Immer | 4K | 0.238ms | 0.303ms | 1000 |
| Seamless Immutable | 4K | 0.255ms | 0.462ms | 1000 |
...
| Mutative | 109K | 0.009ms | 0.023ms | 1000 |
...
| Immer | 148K | 0.007ms | 0.022ms | 1000 |
...
| Immer | 65K | 0.017ms | 0.035ms | 1000 |
...
| Library | ops/sec | Mean Time | P99 | Samples |
|---------|---------|-----------|-----|----------|
| Immutable.js | 793K | 0.001ms | 0.002ms | 1000 |
| Native Spread | 496K | 0.003ms | 0.004ms | 1000 |
| Mutative | 161K | 0.007ms | 0.019ms | 1000 |
...
| Mutative | 523K | 0.002ms | 0.004ms | 1000 |
...
| Native Spread | 659K | 0.002ms | 0.003ms | 1000 |
| Craft | 91K | 0.017ms | 0.045ms | 1000 |
| Immer | 45K | 0.023ms | 0.040ms | 1000 |
| Mutative | 37K | 0.030ms | 0.064ms | 1000 |
...
*Generated on 2025-11-14T15:17:08.669Z*
