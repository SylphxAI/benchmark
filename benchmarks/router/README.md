...
- **⚡ Maximum Performance**: Zen Router - Fastest overall with 97.6/100 score
...
| Rank | Library | Overall Score | Relative Performance | Links |
|:----:|---------|--------------|---------------------|:-----:|
| 🥇 1 | **[Zen Router](https://github.com/SylphxAI/zen-router)** | 97.6/100 | 100% of fastest | [📦](https://www.npmjs.com/package/@sylphx/zen-router) [📊](https://bundlephobia.com/package/@sylphx/zen-router) |
...
| 🥉 3 | **[Wouter](https://github.com/molefrog/wouter)** | 85.2/100 | 87% of fastest | [📦](https://www.npmjs.com/package/wouter) [📊](https://bundlephobia.com/package/wouter) |
...
|---------|:-----:|:------------------:|-------------|----------|
| **[Zen Router](https://github.com/SylphxAI/zen-router)** | **97.6** | **1.57 KB** | Tiny and fast router with regex-based matching... | General purpose... |
...
| **[Wouter](https://github.com/molefrog/wouter)** | **85.2** | **2.49 KB** | Minimalist-friendly ~2.1KB routing for React and P... | General purpose... |
...
| React Router | 14K | 0.075ms | 0.117ms | 1000 |
...
| React Router | 18K | 0.058ms | 0.114ms | 1000 |
...
| React Router | 22K | 0.048ms | 0.082ms | 1000 |
...
| React Router | 12K | 0.086ms | 0.127ms | 1000 |
...
| Wouter | 396K | 0.003ms | 0.004ms | 1000 |
| React Router | 7K | 0.137ms | 0.173ms | 1000 |
| React Router | 2K | 0.421ms | 1.031ms | 1000 |
...
| React Router | 14K | 0.075ms | 0.109ms | 1000 |
...
*Generated on 2025-11-15T19:21:34.183Z*
