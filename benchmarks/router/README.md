...
- **⚡ Maximum Performance**: Zen Router - Fastest overall with 97.4/100 score
- **⚖️ Best Balance**: SolidJS Router - Great performance (96.2/100) with good ecosystem
...
| 🥉 3 | **[Wouter](https://github.com/molefrog/wouter)** | 80.1/100 | 81% of fastest | [📦](https://www.npmjs.com/package/wouter) [📊](https://bundlephobia.com/package/wouter) |
...
| Rank | Library | Overall Score | Relative Performance | Links |
|:----:|---------|--------------|---------------------|:-----:|
| 🥇 1 | **[Zen Router](https://github.com/SylphxAI/zen-router)** | 97.4/100 | 100% of fastest | [📦](https://www.npmjs.com/package/@sylphx/zen-router) [📊](https://bundlephobia.com/package/@sylphx/zen-router) |
| 🥈 2 | **[SolidJS Router](https://github.com/solidjs/solid-router)** | 96.2/100 | 99% of fastest | [📦](https://www.npmjs.com/package/@solidjs/router) [📊](https://bundlephobia.com/package/@solidjs/router) |
| 🥉 3 | **[Wouter](https://github.com/molefrog/wouter)** | 84.6/100 | 87% of fastest | [📦](https://www.npmjs.com/package/wouter) [📊](https://bundlephobia.com/package/wouter) |
...
|---------|:-----:|:------------------:|-------------|----------|
| **[Zen Router](https://github.com/SylphxAI/zen-router)** | **97.4** | **1.57 KB** | Tiny and fast router with regex-based matching... | General purpose... |
| **[SolidJS Router](https://github.com/solidjs/solid-router)** | **96.2** | **9.23 KB** | Universal router for Solid with nested routing and... | General purpose... |
| **[Wouter](https://github.com/molefrog/wouter)** | **84.6** | **2.49 KB** | Minimalist-friendly ~2.1KB routing for React and P... | General purpose... |
...
| Wouter | 6.4M | 0.000ms | 0.001ms | 1000 |
| React Router | 51K | 0.020ms | 0.036ms | 1000 |
| React Router | 18K | 0.057ms | 0.110ms | 1000 |
...
| React Router | 13K | 0.078ms | 0.158ms | 1000 |
...
| React Router | 20K | 0.053ms | 0.079ms | 1000 |
...
| React Router | 21K | 0.048ms | 0.070ms | 1000 |
...
| React Router | 18K | 0.057ms | 0.088ms | 1000 |
...
| React Router | 12K | 0.086ms | 0.115ms | 1000 |
...
| Wouter | 401K | 0.003ms | 0.004ms | 1000 |
| React Router | 7K | 0.137ms | 0.173ms | 1000 |
| React Router | 2K | 0.430ms | 1.025ms | 1000 |
...
| React Router | 14K | 0.076ms | 0.108ms | 1000 |
...
*Generated on 2025-11-14T19:05:53.184Z*
