...
- **⚡ Maximum Performance**: Zen Router - Fastest overall with 97.5/100 score
- **⚖️ Best Balance**: SolidJS Router - Great performance (96.4/100) with good ecosystem
...
| 🥉 3 | **[Wouter](https://github.com/molefrog/wouter)** | 80.8/100 | 82% of fastest | [📦](https://www.npmjs.com/package/wouter) [📊](https://bundlephobia.com/package/wouter) |
...
| Rank | Library | Overall Score | Relative Performance | Links |
|:----:|---------|--------------|---------------------|:-----:|
| 🥇 1 | **[Zen Router](https://github.com/SylphxAI/zen-router)** | 97.5/100 | 100% of fastest | [📦](https://www.npmjs.com/package/@sylphx/zen-router) [📊](https://bundlephobia.com/package/@sylphx/zen-router) |
| 🥈 2 | **[SolidJS Router](https://github.com/solidjs/solid-router)** | 96.4/100 | 99% of fastest | [📦](https://www.npmjs.com/package/@solidjs/router) [📊](https://bundlephobia.com/package/@solidjs/router) |
| 🥉 3 | **[Wouter](https://github.com/molefrog/wouter)** | 84.5/100 | 87% of fastest | [📦](https://www.npmjs.com/package/wouter) [📊](https://bundlephobia.com/package/wouter) |
...
|---------|:-----:|:------------------:|-------------|----------|
| **[Zen Router](https://github.com/SylphxAI/zen-router)** | **97.5** | **1.57 KB** | Tiny and fast router with regex-based matching... | General purpose... |
| **[SolidJS Router](https://github.com/solidjs/solid-router)** | **96.4** | **9.23 KB** | Universal router for Solid with nested routing and... | General purpose... |
| **[Wouter](https://github.com/molefrog/wouter)** | **84.5** | **2.49 KB** | Minimalist-friendly ~2.1KB routing for React and P... | General purpose... |
...
| Wouter | 6.4M | 0.000ms | 0.000ms | 1000 |
| React Router | 51K | 0.020ms | 0.036ms | 1000 |
| React Router | 19K | 0.055ms | 0.090ms | 1000 |
...
| React Router | 14K | 0.074ms | 0.116ms | 1000 |
...
| React Router | 21K | 0.048ms | 0.078ms | 1000 |
...
| Wouter | 403K | 0.003ms | 0.004ms | 1000 |
| React Router | 7K | 0.137ms | 0.173ms | 1000 |
| React Router | 2K | 0.421ms | 0.980ms | 1000 |
...
| Wouter | 1.1M | 0.001ms | 0.001ms | 1000 |
| React Router | 56K | 0.019ms | 0.033ms | 1000 |
| React Router | 14K | 0.073ms | 0.097ms | 1000 |
...
*Generated on 2025-11-14T07:06:53.987Z*
