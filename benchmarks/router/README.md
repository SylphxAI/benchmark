...
- **⚡ Maximum Performance**: Zen Router - Fastest overall with 97.7/100 score
- **⚖️ Best Balance**: SolidJS Router - Great performance (96.5/100) with good ecosystem
...
| 🥉 3 | **[Wouter](https://github.com/molefrog/wouter)** | 80.8/100 | 81% of fastest | [📦](https://www.npmjs.com/package/wouter) [📊](https://bundlephobia.com/package/wouter) |
...
| Rank | Library | Overall Score | Relative Performance | Links |
|:----:|---------|--------------|---------------------|:-----:|
| 🥇 1 | **[Zen Router](https://github.com/SylphxAI/zen-router)** | 97.7/100 | 100% of fastest | [📦](https://www.npmjs.com/package/@sylphx/zen-router) [📊](https://bundlephobia.com/package/@sylphx/zen-router) |
| 🥈 2 | **[SolidJS Router](https://github.com/solidjs/solid-router)** | 96.5/100 | 99% of fastest | [📦](https://www.npmjs.com/package/@solidjs/router) [📊](https://bundlephobia.com/package/@solidjs/router) |
| 🥉 3 | **[Wouter](https://github.com/molefrog/wouter)** | 85.6/100 | 88% of fastest | [📦](https://www.npmjs.com/package/wouter) [📊](https://bundlephobia.com/package/wouter) |
...
|---------|:-----:|:------------------:|-------------|----------|
| **[Zen Router](https://github.com/SylphxAI/zen-router)** | **97.7** | **1.57 KB** | Tiny and fast router with regex-based matching... | General purpose... |
...
| **[Wouter](https://github.com/molefrog/wouter)** | **85.6** | **2.49 KB** | Minimalist-friendly ~2.1KB routing for React and P... | General purpose... |
...
| React Router | 13K | 0.084ms | 0.169ms | 1000 |
...
| React Router | 20K | 0.051ms | 0.084ms | 1000 |
...
| React Router | 22K | 0.047ms | 0.071ms | 1000 |
...
| React Router | 20K | 0.054ms | 0.093ms | 1000 |
...
| React Router | 12K | 0.086ms | 0.123ms | 1000 |
...
| Wouter | 385K | 0.003ms | 0.004ms | 1000 |
| React Router | 7K | 0.137ms | 0.173ms | 1000 |
| React Router | 2K | 0.418ms | 1.050ms | 1000 |
...
| React Router | 14K | 0.074ms | 0.098ms | 1000 |
...
*Generated on 2025-11-14T15:17:08.672Z*
